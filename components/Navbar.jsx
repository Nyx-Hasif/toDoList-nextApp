...
const Navbar = () => {
  return (
      ...
      <div className="flex flex-wrap w-full md:w-fit md:flex-col gap-4 fixed bottom-0  md:bottom-0 md:right-0 border border-black px-6 py-4  text-white text-sm md:text-lg font-medium bg-slate-900">
